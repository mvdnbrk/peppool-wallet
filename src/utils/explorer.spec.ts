...
describe('Pepe Explorer Utility', () => {
    ...
    it('should generate correct address URLs', () => {
        const address = 'P123';
        expect(pepeExplorer.getAddressUrl('peppool', address)).toBe('https://peppool.space/address/P123');
        expect(pepeExplorer.getAddressUrl('pepeblocks', address)).toBe('https://pepeblocks.com/address/P123');
    });

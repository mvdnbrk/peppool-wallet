...
describe('Settings Views Navigation', () => {
  ...
  it('SettingsView: should have a backTo prop set to /dashboard', () => {
    const wrapper = mount(SettingsView, { global: { stubs, components: { PepPageHeader, PepMainLayout } } });
  ...
  it('AboutView: should use default router.back()', () => {
    const wrapper = mount(AboutView, { global: { stubs, components: { PepPageHeader, PepMainLayout } } });
    const header = wrapper.findComponent(PepPageHeader);
  ...
  it('SecurityView: should use default router.back()', () => {
    const wrapper = mount(SecurityView, { global: { stubs, components: { PepPageHeader, PepMainLayout } } });
    const header = wrapper.findComponent(PepPageHeader);
    expect(header.props('backTo')).toBeUndefined();
    expect(header.props('onBack')).toBeUndefined();
  });
  ...
  it('PreferencesView: should use default router.back()', () => {
    const wrapper = mount(PreferencesView, { global: { stubs, components: { PepPageHeader, PepMainLayout } } });
    const header = wrapper.findComponent(PepPageHeader);
    expect(header.props('backTo')).toBeUndefined();
    expect(header.props('onBack')).toBeUndefined();
  });
  ...
  it('ChangePasswordView: should use default router.back()', () => {
    const wrapper = mount(ChangePasswordView, { global: { stubs, components: { PepPageHeader, PepMainLayout } } });
    const header = wrapper.findComponent(PepPageHeader);
    expect(header.props('backTo')).toBeUndefined();
    expect(header.props('onBack')).toBeUndefined();
  });
  ...
  it('ResetWalletView: should use default router.back()', () => {
    const wrapper = mount(ResetWalletView, { global: { stubs, components: { PepPageHeader, PepMainLayout } } });
    const header = wrapper.findComponent(PepPageHeader);
    expect(header.props('backTo')).toBeUndefined();
    expect(header.props('onBack')).toBeUndefined();
  });
  ...
  it('ShowMnemonicView: should use default router.back()', () => {
    const wrapper = mount(ShowMnemonicView, { global: { stubs, components: { PepPageHeader, PepMainLayout } } });
    const header = wrapper.findComponent(PepPageHeader);
    expect(header.props('backTo')).toBeUndefined();
    expect(header.props('onBack')).toBeUndefined();
  });
  ...
  it('AutoLockView: should use default router.back()', () => {
    const wrapper = mount(AutoLockView, { global: { stubs, components: { PepPageHeader, PepMainLayout } } });
    const header = wrapper.findComponent(PepPageHeader);
    expect(header.props('backTo')).toBeUndefined();
    expect(header.props('onBack')).toBeUndefined();
  });
  ...
  it('CurrencyView: should use default router.back()', () => {
    const wrapper = mount(CurrencyView, { global: { stubs, components: { PepPageHeader, PepMainLayout } } });
    const header = wrapper.findComponent(PepPageHeader);
    expect(header.props('backTo')).toBeUndefined();
    expect(header.props('onBack')).toBeUndefined();
  });
  ...
  it('PreferredExplorerView: should use default router.back()', () => {
    const wrapper = mount(PreferredExplorerView, { global: { stubs, components: { PepPageHeader, PepMainLayout } } });
    const header = wrapper.findComponent(PepPageHeader);
    expect(header.props('backTo')).toBeUndefined();
    expect(header.props('onBack')).toBeUndefined();
  });

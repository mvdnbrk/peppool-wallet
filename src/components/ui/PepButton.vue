...
<template>
  <button
    ...
    :class="[
      {
        'bg-pep-green text-white hover:bg-pep-green-light focus-visible:outline-pep-green': variant === 'primary',
        'bg-red-600 text-white hover:bg-red-500 focus-visible:outline-red-600': variant === 'danger',

...
const icons = {
  ...
  'error': 'M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14ZM8 4a.75.75 0 0 1 .75.75v3a.75.75 0 0 1-1.5 0v-3A.75.75 0 0 1 8 4Zm0 8a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z',
...
<template>
  <svg
    ...
    :class="props.class"
  >
    <path :d="icons[name]" :fill-rule="name === 'error' || name === 'check' || name === 'clear' || name === 'checkmark-circle' ? 'evenodd' : undefined" :clip-rule="name === 'error' || name === 'check' || name === 'clear' || name === 'checkmark-circle' ? 'evenodd' : undefined" stroke-width="1.5" :stroke="name === 'eye' || name === 'eye-slash' || name === 'swap' ? 'currentColor' : 'none'" :fill="name === 'eye' || name === 'eye-slash' || name === 'swap' ? 'none' : 'currentColor'" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
</template>
